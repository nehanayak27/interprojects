	...
	public static void main(String[] args) throws Exception {
		...
		//fetching the data from the excel file
			...
			for(int i=1;i<nour;i++)
			{
				...
				driver.findElement(By.id("glaeGLAccount_dropText")).sendKeys("12380120");
				Thread.sleep(1000);
			...
			//used sikuli for the click functionality. 
			...
			Thread.sleep(1000);
			driver.findElement(By.id("txtNaturalAccount")).sendKeys("1238");  
			Thread.sleep(1000);
			...
			//delete the record
			driver.findElement(By.id("toolMenu")).click();
			sc.click("E:\\Batch251Selenium\\Selenium1\\seleniumPrac\\project\\src\\test\\resources\\filebut.PNG");
			Thread.sleep(1000);
			sc.click("E:\\Batch251Selenium\\Selenium1\\seleniumPrac\\project\\src\\test\\resources\\deletebut.PNG");
